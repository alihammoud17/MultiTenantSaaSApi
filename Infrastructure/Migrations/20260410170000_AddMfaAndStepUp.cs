...
{
    public partial class AddMfaAndStepUp : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_UserMfaEnrollmentChallenges", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_UserStepUpSessions", x => x.Id); });
        ...
        {
            migrationBuilder.DropTable(name: "UserMfaEnrollmentChallenges");
            migrationBuilder.DropTable(name: "UserStepUpSessions");
            migrationBuilder.DropColumn(name: "MfaEnabledAt", table: "Users");
